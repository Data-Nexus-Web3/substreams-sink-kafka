-- Create a clean, fresh table for flattened messages
...
DROP TABLE IF EXISTS ADR_FLATTENED_MESSAGES;

-- Create a clean table for the new connector
CREATE TABLE ADR_FLATTENED_CLEAN (
...
CREATE OR REPLACE VIEW FLATTENED_MESSAGES_CLEAN_ANALYSIS AS
SELECT 
...
FROM EXPLOSION_TEST.ADR_FLATTENED_CLEAN;

-- Show the clean table structure
DESCRIBE TABLE ADR_FLATTENED_CLEAN; 